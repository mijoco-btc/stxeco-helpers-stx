...
export declare function pollVotesToClarityValue(pollVotes: StoredPollVoteMessage[]): {
    pollVotesCV: import("@stacks/transactions").ListCV<import("@stacks/transactions").TupleCV<import("@stacks/transactions").TupleData<import("@stacks/transactions").BufferCV | import("@stacks/transactions").TupleCV<import("@stacks/transactions").TupleData<import("@stacks/transactions").TrueCV | import("@stacks/transactions").FalseCV | import("@stacks/transactions").BufferCV | import("@stacks/transactions").UIntCV | import("@stacks/transactions").StandardPrincipalCV | import("@stacks/transactions").ContractPrincipalCV | import("@stacks/transactions").NoneCV | import("@stacks/transactions").StringAsciiCV | import("@stacks/transactions").SomeCV<import("@stacks/transactions").UIntCV> | import("@stacks/transactions").SomeCV<import("@stacks/transactions").PrincipalCV> | import("@stacks/transactions").SomeCV<import("@stacks/transactions").ListCV<import("@stacks/transactions").BufferCV>>>>>>>;
};
